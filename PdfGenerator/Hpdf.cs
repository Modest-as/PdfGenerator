...
namespace PdfGenerator
{
    ...
    public class HPdfDoc : IDisposable
    {
        ...
        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_LoadType1FontFromFile(IntPtr pdf,
            string afmfilename, string pfmfilename);

        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_LoadTTFontFromFile(IntPtr pdf,
            string file_name, int embedding);

        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_LoadTTFontFromFile2(IntPtr pdf,
        ...
        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_GetInfoAttr(IntPtr pdf,
            HPdfInfoType type);
        ...
        public string LoadTTFontFromFile(string file_name, bool embedding)
        {
            ...
            emb = embedding ? HPDF_TRUE : HPDF_FALSE;
            ...
            HPdfEncoder encoder)
        {
            ...
            hencoder = encoder?.GetHandle() ?? IntPtr.Zero;

            hparent = parent?.GetHandle() ?? IntPtr.Zero;
    ...
    public class HPdfPage
    {
            ...
            ref float real_width)
        {
            ...
            ww = wordwrap ? HPDF_TRUE : HPDF_FALSE;
        ...
        public void SetDash(ushort[] dash_ptn, uint phase)
        {
            if (dash_ptn == null)
            {
                HPDF_Page_SetDash(hpage, null, 0, 0);
                return;
            }
    ...
    {
        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_Font_GetFontName(IntPtr hfont);

        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_Font_GetEncodingName(IntPtr hfont);
    ...
    public class HPdfOutline
    {
        ...
        public void SetOpened(bool opened)
        {
            ...
            iopened = opened ? HPdfDoc.HPDF_TRUE : HPdfDoc.HPDF_FALSE;
    ...
    public class HPdfAnnotation
    {
        ...
        public void SetOpened(bool opened)
        {
            ...
            flg = opened ? HPdfDoc.HPDF_TRUE : HPdfDoc.HPDF_FALSE;
    ...
    public class HPdfImage : HPdfXObject
    {
        ...
        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_Image_GetColorSpace(IntPtr image);
        ...
        [DllImport("Lib\\libhpdf.dll")]
        private static extern string HPDF_Image_SetMaskImage(IntPtr image,
            IntPtr mask_image);
